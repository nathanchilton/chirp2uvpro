...
class TestBtechParserSubAudio(unittest.TestCase):
    def test_rx_sub_audio_sync_with_tx_when_rf_missing(self):
        ...
        json_content = '{"chs": [{"n": "Test", "tf": 462.0, "t": 1000, "ts": 1000}]}'
        ...
        self.assertEqual(ch.rx_sub_audio_hz, 1000.0, "rx_sub_audio_hz should sync with tx_sub_audio_hz when rf is missing")
